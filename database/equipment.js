...
const EQUIPMENT_DB = {
    ...
    "eq_rust_weapon": { id: "eq_rust_weapon", name: "Rustic Club", slot: "weapon", synergy: "damage", base_stats: { damage: 7 }, slots_total: 3, slots_unlocked: 1, icon: 'images/icons/equipment/eq_rustic_club.png' },
